  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      dialog {
        ...
        box-shadow: 0 20px 58px rgba(10, 24, 28, .24) !important;
      ...
      dialog > .dialog-card,
      dialog > .client-history-card,
      dialog > .invoice-created-card,
      dialog > .stage-dialog-card,
      dialog > .app-settings-card {
        box-sizing: border-box;
        margin: 0 !important;
        max-width: calc(100vw - 18px) !important;
      }
      dialog > .dialog-card:not(.wide):not(.email-dialog):not(.client-dialog-card) {
        width: min(960px, calc(100vw - 18px)) !important;
      }
      dialog > .dialog-card.wide {
        width: min(1060px, calc(100vw - 18px)) !important;
      }
      dialog > .dialog-card.email-dialog {
        width: min(1160px, calc(100vw - 18px)) !important;
      }
      dialog > .dialog-card.client-dialog-card {
        width: min(900px, calc(100vw - 18px)) !important;
      }
      dialog::backdrop,
      ...
      .weset-expanded-window {
        background: #fff !important;
        border: 1px solid rgba(20, 92, 88, .16) !important;
        box-shadow: 0 20px 58px rgba(10, 24, 28, .22) !important;
      }
